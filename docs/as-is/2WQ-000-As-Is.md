# AS-IS Document: 2WQ-000 - Java Demo Para Sesion de CCOE-CMO

> **Document Purpose**: This document captures the current state of project 2WQ-000 as it exists today in Bitbucket. It serves as a reference point for understanding what we have before planning any migrations or changes.
...
**Current Project Owner**: Pedro Simoes

**Current Technical Lead**: John Doe

**Repository Location**: Bitbucket (mcp/bitbucket/2WQ-000)
...
|------------|---------|---------|
| Java | 8, 11 | Primary programming language |
...
| Technology | Version | Purpose |
|------------|---------|---------|
| Angular | 7.x | Frontend framework (jhipster example) |
...
#### Demo/Example Nature
- **Purpose**: Educational and demonstration purposes for CCOE-CMO sessions
